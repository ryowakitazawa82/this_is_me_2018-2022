    ...
    <div class="common-white-box">
      <div class="common-white-box__inner">
        ...
        <div class="common-w-title__des">
          <p>webを中心に様々なマーケティングを経験してきました。</p>
        </div>
        ...
        <div class="fadein" v-scroll="handleScroll">
          ...
          <div class="common-w-h2__des">
            <p>
              大学2年生の秋より、総合広告代理店ADKにインターン生としてジョイン。ブランディングやマーケティング思考を学び、コミュニケーション戦略立案やトレンド分析などを行ってきました。
            </p>
          </div>
          ...
          <div class="common-w-content__wrap">
            ...
            <div class="common-w-h3__img">
              <img
                src="/this_is_me_2018-2022/images/sogo_01.png"
                alt="白熱している議論の様子"
                oncontextmenu="return false;"
              />
            </div>
          ...
          <div class="common-w-content__wrap width-max">
            ...
            <div class="common-w-content__flex">
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/sogo_02.png"
                  alt="トレンド分析の資料の1枚目"
                  oncontextmenu="return false;"
                />
              </div>
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/sogo_03.png"
                  alt="トレンド分析の資料の2枚目"
                  oncontextmenu="return false;"
                />
              </div>
        ...
        <div class="fadein" v-scroll="handleScroll">
          ...
          <div class="common-w-content__flex">
            <div class="common-w-content__wrap">
              ...
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/wm_01.png"
                  alt="運用報告資料"
                  oncontextmenu="return false;"
                />
              </div>
            ...
            <div class="common-w-content__wrap">
              ...
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/wm_02.png"
                  alt="アナリティクスの管理画面"
                  oncontextmenu="return false;"
                />
              </div>
            ...
            <div class="common-w-content__wrap">
              ...
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/wm_03.png"
                  alt="miroの画面"
                  oncontextmenu="return false;"
                />
              </div>
        ...
        <div class="fadein" v-scroll="handleScroll">
          ...
          <div class="common-w-content__wrap width-max">
            ...
            <div class="common-w-content__flex">
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/timimk_01.png"
                  alt="timiマーケ資料"
              ...
              <div class="common-w-h3__img">
                <img
                  src="/this_is_me_2018-2022/images/timimk_02.png"
                  alt="timiマーケmiro"
                  class="timi-shiryo-img"
                  oncontextmenu="return false;"
                />
