    ...
    <div class="common-white-box">
        <div class="common-white-box__inner">
            ...
            <div class="common-w-title__des">
                <p>歴と経験はマーケターが一番。3年末まではマーケティングを極めようと思っていました。</p>
            </div>
            ...
            <div class="common-w-h2__des">
                <p>大学2年生の秋より、総合広告代理店ADKにインターン生としてジョイン。ブランディングやマーケティング思考を学び、コミュニケーション戦略立案やトレンド分析などを行ってきました。</p>
            </div>
            ...
            <div class="common-w-content__wrap">
                ...
                <div class="common-w-h3__img">
                    <img src="/images/sogo_02.png" alt="トレンド分析の資料の1枚目">
                </div>
                <div class="common-w-h3__img">
                    <img src="/images/sogo_03.png" alt="トレンド分析の資料の2枚目">
                </div>
            </div>
            ...
            <div class="common-w-h2__des">
                <p>WEB広告運用やSEO対策、SNSマーケの戦略立案・運用などをしてきました。</p>
            </div>
